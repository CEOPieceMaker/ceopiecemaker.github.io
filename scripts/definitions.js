...
TOOLTIPS = {
    ...
    tfA: "Pink fill color, for those who want colorful pieces for some reason",
    tfB: "Super dark fill color, in case Black wasn't dark enough",
    tfC: "Solid white fill",
    tfD: "Enchantment overlay",
    tfE: "Rainbow gradient, for those who want REALLY colorful pieces",
    tfF: "Coloring resembling a black ChaosPortal",
